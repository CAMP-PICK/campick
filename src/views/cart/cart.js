    ...
    <div class="card">
      ...
      <div class="card-content">
        ...
        <div class="columns is-mobile is-vcentered is-multiline">
          ...
          <div class="column is-12"><input class="input ${genItemClassNames(cn.itemQuantity, _id)}" ${genDatasetIdAttr(_id)} type="number" min="1" max="${productStock}" value="${quantity}" ></div>
        </div>
      </div>
